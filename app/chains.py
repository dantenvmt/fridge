...
class Chain:
    ...
    def analyze_resume(self, resume_text, job_description, link, skill):
        ...
        prompt_cover_letter = PromptTemplate.from_template(
            ...
            In your job description, you mention (the list the skills required by the company):{skill} 
            then use summarized keypoints mentioned in the resume to support your claim 
            for each skills required by job description after each item in the list if possible.
